#!/usr/bin/python3
"""objects that handling all default RestFul API actions for cities"""
...
def get_cities(state_id):
    """Retrieval of the list of all cities objects of a specific State, or a specific city """
    list_cities = []
...
def get_city(city_id):
    """Retrieval of a specific city based on id"""
...
def delete_city(city_id):
    """Deletion a city based on id provided"""
    city = storage.get(City, city_id)
